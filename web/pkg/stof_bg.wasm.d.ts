...
export const stofnode_validateAll: (a: number, b: number) => number;
...
export const stofdoc_run: (a: number) => [number, number];
export const stofdoc_runAt: (a: number, b: number) => [number, number];
...
export const stofdata_validateValue: (a: number, b: number) => number;
